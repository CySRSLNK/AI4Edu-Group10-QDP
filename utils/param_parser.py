...
def parameter_parser():
    ...
    # Data Parameters
    parser.add_argument('--train-file', nargs='?', default='data/train/sample_train.json', help='Training data.')
    parser.add_argument('--validation-file', nargs='?', default='data/validation/sample_valid.json', help='Validation data.')
    parser.add_argument('--test-file', nargs='?', default='data/test/sample_test.json', help='Testing data.')
    ...
    parser.add_argument("--l2-lambda", type=float, default=0, help="L2 regularization lambda.")
    ...
    parser.add_argument('--include-knowledge', type=bool, default=False,
